...
const ContactTable = () => {
  ...
  return (
    <div style={{ padding: '40px', maxWidth: '100%', margin: '0 auto', fontFamily: 'Arial' }}>
      <h2 style={{ fontSize: '26px', marginBottom: '20px', textAlign: 'center' }}>
        📨 Contact Messages
      </h2>
      ...
      {isModalOpen && viewedContact && (
        ...
        >
          ...
          >
            <h3 style={{ fontSize: '22px', marginBottom: '12px' }}>{viewedContact.title}</h3>
            <p><strong>Name:</strong> {viewedContact.name}</p>
            <p><strong>Email:</strong> {viewedContact.email}</p>
            <p><strong>Message:</strong></p>
            <p style={{ marginTop: '10px', lineHeight: '1.5' }}>{viewedContact.message}</p>
